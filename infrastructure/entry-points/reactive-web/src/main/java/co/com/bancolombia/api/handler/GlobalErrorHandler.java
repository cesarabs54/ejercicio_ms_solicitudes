...
import co.com.bancolombia.api.dto.response.ErrorMessage;
...
public class GlobalErrorHandler extends AbstractErrorWebExceptionHandler {
    ...
    public GlobalErrorHandler(ApplicationContext applicationContext,
        ...
        // OJO: en 3.5.x el ctor requiere (ErrorAttributes, WebProperties.Resources, ApplicationContext)
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ...
        switch (e) {
            case MethodArgumentTypeMismatchException e1 -> {
                status = HttpStatus.BAD_REQUEST;
                message = "Tipo de argumento inválido: " + e1.getName();
            }
